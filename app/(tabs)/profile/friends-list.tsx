...
import { ArrowLeft, MessageCircle, RefreshCw, Clock, Circle } from 'lucide-react-native';
            ...
            <View style={styles.statusContainer}>
              {item.is_online ? (
                <View style={styles.onlineStatusContainer}>
                  <Circle size={8} fill="#4cd137" color="#4cd137" />
                ...
                <View style={styles.lastSeenContainer}>
                  ...
                  <Text style={styles.lastSeenText}>
                    {item.last_seen_at ? formatLastSeenTime(item.last_seen_at) : 'Çevrimdışı'}
                  </Text>
                </View>
              )}
            </View>
